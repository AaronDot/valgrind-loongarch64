                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 18)) {
      case 0b1101:
         ok = gen_xvmax_xvmin(dres, insn, archinfo, abiinfo); break;
      default: ok = False; break;
   }
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 18)) {
      case 0b1001: case 0b1010: case 0b1011:
         ok = gen_xvpermi(dres, insn, archinfo, abiinfo); break;
      default: ok = False; break;
   }
                                               ...
                                               const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 25, 22)) {
      ...
      case 0b0001:
         ok = disInstr_LOONGARCH64_WRK_01_1101_0001(dres, insn, archinfo, abiinfo); break;
      case 0b0100:
         ok = disInstr_LOONGARCH64_WRK_01_1101_0100(dres, insn, archinfo, abiinfo); break;
      case 0b1010:
      ...
      case 0b1111:
         ok = disInstr_LOONGARCH64_WRK_01_1101_1111(dres, insn, archinfo, abiinfo); break;
      default:
         ok = False; break;
   }
