...
#if 0
static void dis_ins_ui3_to_ui6(UInt insImm, UInt *uImm, UInt *insSz)
{
...
{
   IRTemp cnt8   = newTempV128();
   IRTemp add16 = newTempV128();
   IRTemp add32 = newTempV128();
                                ...
                                const VexAbiInfo*  abiinfo )
{
   ...
   assign(tmpOd, unop(widenOp, binop(mkVecPACKOD(insSz),
                                     getVReg(vj), mkV128(0x0000))));
   assign(tmpEv, unop(widenOp, binop(mkVecPACKEV(insSz),
                                    ...
                                    const VexAbiInfo* abiinfo )
{
   ...
   assign(argL, unop(mkVecEXTHTU(insSz), binop(packOp,
                                               getVReg(vj), mkV128(0x0000))));
   assign(argR, unop(mkVecEXTHTS(insSz), binop(packOp,
                                               getVReg(vk), mkV128(0x0000))));
   ...
   switch (insSz) {
      case 0b00: {
         ...
         for (i = 0; i < 16; i++) {
            ...
            assign(argL[i], extendS(Ity_I8, binop(Iop_GetElem8x16, getVReg(vj), mkU8(i))));
            assign(argR[i], extendS(Ity_I8, binop(Iop_GetElem8x16, getVReg(vk), mkU8(i))));
            assign(arg[i], IRExpr_ITE(binop(Iop_CmpLT64S, mkexpr(argR[i]), mkexpr(argL[i])),
         ...
         assign(res, binop(Iop_64HLtoV128,
                           binop(Iop_32HLto64,
                                 binop(Iop_16HLto32,
                                       binop(Iop_8HLto16, mkexpr(arg[15]), mkexpr(arg[14])),
                                       binop(Iop_8HLto16, mkexpr(arg[13]), mkexpr(arg[12]))),
                                 binop(Iop_16HLto32,
                                       binop(Iop_8HLto16, mkexpr(arg[11]), mkexpr(arg[10])),
                                       binop(Iop_8HLto16, mkexpr(arg[9]), mkexpr(arg[8])))),
                           binop(Iop_32HLto64,
                                 binop(Iop_16HLto32,
                                       binop(Iop_8HLto16, mkexpr(arg[7]), mkexpr(arg[6])),
                                       binop(Iop_8HLto16, mkexpr(arg[5]), mkexpr(arg[4]))),
                                 binop(Iop_16HLto32,
                                       binop(Iop_8HLto16, mkexpr(arg[3]), mkexpr(arg[2])),
                                       binop(Iop_8HLto16, mkexpr(arg[1]), mkexpr(arg[0]))))));
         break;
      }
      case 0b01: {
         IRTemp argL[8];
         ...
         for (i = 0; i < 8; i++) {
            ...
            assign(argL[i], extendS(Ity_I16, binop(Iop_GetElem16x8, getVReg(vj), mkU8(i))));
            assign(argR[i], extendS(Ity_I16, binop(Iop_GetElem16x8, getVReg(vk), mkU8(i))));
            assign(arg[i], IRExpr_ITE(binop(Iop_CmpLT64S, mkexpr(argR[i]), mkexpr(argL[i])),
         ...
         assign(res, binop(Iop_64HLtoV128,
                           binop(Iop_32HLto64,
                                 binop(Iop_16HLto32, mkexpr(arg[7]), mkexpr(arg[6])),
                                 binop(Iop_16HLto32, mkexpr(arg[5]), mkexpr(arg[4]))),
                           binop(Iop_32HLto64,
                                 binop(Iop_16HLto32, mkexpr(arg[3]), mkexpr(arg[2])),
                                 binop(Iop_16HLto32, mkexpr(arg[1]), mkexpr(arg[0])))));
         break;
      }
      case 0b10: {
         IRTemp argL[4];
         ...
         for (i = 0; i < 4; i++) {
            ...
            assign(argL[i], extendS(Ity_I32, binop(Iop_GetElem32x4, getVReg(vj), mkU8(i))));
            assign(argR[i], extendS(Ity_I32, binop(Iop_GetElem32x4, getVReg(vk), mkU8(i))));
            assign(arg[i], IRExpr_ITE(binop(Iop_CmpLT64S, mkexpr(argR[i]), mkexpr(argL[i])),
         ...
         assign(res, binop(Iop_64HLtoV128,
                           binop(Iop_32HLto64, mkexpr(arg[3]), mkexpr(arg[2])),
                           binop(Iop_32HLto64, mkexpr(arg[1]), mkexpr(arg[0]))));
         break;
      }
      case 0b11: {
         IRTemp argL[2];
         ...
         for (i = 0; i < 2; i++) {
            ...
            assign(argL[i], binop(Iop_GetElem64x2, getVReg(vj), mkU8(i)));
            assign(argR[i], binop(Iop_GetElem64x2, getVReg(vk), mkU8(i)));
            assign(arg[i], IRExpr_ITE(binop(Iop_CmpLT64S, mkexpr(argR[i]), mkexpr(argL[i])),
                                      binop(Iop_Sub64, mkexpr(argL[i]), mkexpr(argR[i])),
                                      binop(Iop_Sub64, mkexpr(argR[i]), mkexpr(argL[i]))));
         }
         assign(res, binop(Iop_64HLtoV128, mkexpr(arg[1]), mkexpr(arg[0])));
         break;
      }
      default: vassert(0);
   }
                              ...
                              const VexAbiInfo* abiinfo )
{
   ...
   assign(s64, mkU64(extend64(ui5, 5)));
   switch (insSz) {
      case 0b00:
...
static IRTemp gen_vdiv_b ( UInt isMod, UInt isU, IRTemp argL, IRTemp argR )
{
   UInt i;
   IRTemp tmpL[16];
   IRTemp tmpR[16];
...
static IRTemp gen_vdiv_h ( UInt isMod, UInt isU, IRTemp argL, IRTemp argR )
{
   UInt i;
   IRTemp tmpL[8];
   IRTemp tmpR[8];
...
static IRTemp gen_vdiv_w ( UInt isMod, UInt isU, IRTemp argL, IRTemp argR )
{
   UInt i;
   IRTemp tmpL[4];
   IRTemp tmpR[4];
...
static IRTemp gen_vdiv_d ( UInt isMod, UInt isU, IRTemp argL, IRTemp argR )
{
                       ...
                       const VexAbiInfo* abiinfo )
{
   ...
   switch (insSz) {
      case 0b00: res = gen_vdiv_b(isMod, isU, argL, argR); break;
      case 0b01: res = gen_vdiv_h(isMod, isU, argL, argR); break;
      case 0b10: res = gen_vdiv_w(isMod, isU, argL, argR); break;
      case 0b11: res = gen_vdiv_d(isMod, isU, argL, argR); break;
      default: vassert(0);
   }
...
{
   IRTemp satVal = newTempV128();
   IRTemp res    = newTempV128();
   UInt sarNum[4] = {7, 15, 31, 63};

   if (uImm == sarNum[insSz]) {
      assign(res, mkexpr(src));
      return res;
   }
   assign(satVal, binop(mkVecCMPEQ(insSz),
                        binop(mkVecSHRN(insSz),
                              mkexpr(src),
                              mkU8(uImm + 1)),
                        mkV128(0x0000)));
   assign(res, binop(Iop_OrV128,
                     binop(Iop_AndV128,
                           ...
                           mkexpr(src)),
                     binop(mkVecSHRN(insSz),
                           unop(Iop_NotV128, mkexpr(satVal)),
...
static IRTemp vsat_s ( IRTemp src, UInt insSz, UInt uImm )
{
   ...
   assign(satVal, binop(mkVecSARN(insSz),
                        mkexpr(src),
                        mkU8(sarNum[insSz])));

   if (uImm == 0) {
      assign(res, mkexpr(satVal));
      return res;
   }

   assign(tmp, binop(mkVecSARN(insSz), mkexpr(src), mkU8(uImm)));
   assign(res, binop(Iop_OrV128,
                     binop(Iop_OrV128,
                           binop(Iop_AndV128,
                                 binop(mkVecCMPEQ(insSz),
                                       mkexpr(satVal), mkexpr(tmp)),
                                 mkexpr(src)),
                           binop(mkVecSHLN(insSz),
                                 binop(mkVecCMPGTS(insSz),
                                       mkexpr(satVal), mkexpr(tmp)),
                                 mkU8(uImm))),
                     binop(mkVecSHRN(insSz),
                           binop(mkVecCMPGTS(insSz),
                                 mkexpr(tmp), mkexpr(satVal)),
                           ...
                           const VexAbiInfo*  abiinfo )
{
   ...
   IRTemp lt = newTempV128();
   IRTemp gt = newTempV128();
   UInt sarNum[4] = {7, 15, 31, 63};

   assign(eq, unop(Iop_NotV128,
                   binop(mkVecCMPEQ(insSz), getVReg(vj), mkV128(0x0000))));
   assign(lt, binop(Iop_AndV128,
                    binop(mkVecSARN(insSz), getVReg(vj), mkU8(sarNum[insSz])),
                    binop(mkVecSUB(insSz), mkV128(0x0000), getVReg(vk))));
...
static IRTemp gen_vrotr ( UInt insSz, IRTemp vj, IRTemp vk )
{
   IRTemp shr = newTempV128();
   IRTemp shl = newTempV128();
   IRTemp dup = newTempV128();
   IRTemp shlR = newTempV128();
   IRTemp res = newTempV128();

   switch (insSz) {
      case 0b00: {
         assign(dup, unop(Iop_Dup8x16, mkU8(8)));
         assign(shlR, binop(Iop_Sub8x16,
                            mkexpr(dup),
                            mkexpr(gen_vdiv_b(1, 1, vk, dup))));
         break;
      }
      case 0b01: {
         assign(dup, unop(Iop_Dup16x8, mkU16(16)));
         assign(shlR, binop(Iop_Sub16x8,
                            mkexpr(dup),
                            mkexpr(gen_vdiv_h(1, 1, vk, dup))));
         break;
      }
      case 0b10: {
         assign(dup, unop(Iop_Dup32x4, mkU32(32)));
         assign(shlR, binop(Iop_Sub32x4,
                            mkexpr(dup),
                            mkexpr(gen_vdiv_w(1, 1, vk, dup))));
         break;
      }
      case 0b11: {
         assign(dup, binop(Iop_64HLtoV128, mkU64(64), mkU64(64)));
         assign(shlR, binop(Iop_Sub64x2,
                            mkexpr(dup),
                            mkexpr(gen_vdiv_d(1, 1, vk, dup))));
         break;
      }
      default: vassert(0);
   }

   assign(shr, binop(mkVecSHR(insSz), mkexpr(vj),  mkexpr(vk)));
   assign(shl, binop(mkVecSHL(insSz), mkexpr(vj), mkexpr(shlR)));
   assign(res, binop(Iop_OrV128, mkexpr(shr), mkexpr(shl)));
   return res;
}
                         ...
                         const VexAbiInfo* abiinfo )
{
   ...
   switch (insTy) {
      case 0b00: {
         assign(res, binop(mkVecSHL(insSz), mkexpr(argL), mkexpr(argR)));
         break;
      }
      case 0b01: {
         assign(res, binop(mkVecSHR(insSz), mkexpr(argL), mkexpr(argR)));
         break;
      }
      case 0b10: {
         assign(res, binop(mkVecSAR(insSz), mkexpr(argL), mkexpr(argR)));
         break;
      }
      case 0b11: {
         res = gen_vrotr(insSz, argL, argR);
         break;
      }
      default: vassert(0);
   }
                          ...
                          const VexAbiInfo* abiinfo )
{
   ...
   assign(srcHi, binop(Iop_InterleaveLO64x2,
                       getVReg(vj),
                       mkV128(0x0000)));
...
static IRTemp vsrlr_ops ( UInt vj, UInt vk, IROp shrOp, UInt insSz )
{
   IRTemp argL    = newTempV128();
   IRTemp argR    = newTempV128();
   IRTemp subRes  = newTempV128();
   IRTemp notRes  = newTempV128();
   IRTemp subR    = newTempV128();
   IRTemp res     = newTempV128();
   ...
   assign(argR, binop(mkVecSHRN(insSz),
                      binop(Iop_AndV128,
                            binop(mkVecSHL(insSz),
                                  getVReg(vj),
                                  mkexpr(subRes)),
                            mkexpr(notRes)),
                      mkU8(shrNum[insSz])));
   assign(res, binop(mkVecADD(insSz), mkexpr(argL), mkexpr(argR)));
                        ...
                        const VexAbiInfo* abiinfo )
{
   ...
   IRTemp res = newTempV128();
   res = vsrlr_ops(vj, vk, shrOp, insSz);
...
static IRTemp gen_vrotri ( UInt insSz, IRTemp vj, UInt imm )
{
   IRTemp shr  = newTempV128();
   IRTemp shl  = newTempV128();
   IRTemp shrR = newTempV128();
   IRTemp shlR = newTempV128();
   IRTemp res  = newTempV128();
   IRExpr* sub;
   ...
   assign(shr, binop(mkVecSHR(insSz), mkexpr(vj), mkexpr(shrR)));
   assign(shl, binop(mkVecSHL(insSz), mkexpr(vj), mkexpr(shlR)));
   assign(res, binop(Iop_OrV128, mkexpr(shr), mkexpr(shl)));
   return res;
}
                         ...
                         const VexAbiInfo* abiinfo )
{
   ...
   switch (insTy) {
      ...
      case 0b10: {
         IRTemp argL = newTempV128();
         IRTemp argR = newTempV128();
         IROp shrOp  = (insTy == 0b10) ? mkVecSARN(insSz) : mkVecSHRN(insSz);
         assign(argL, binop(shrOp, mkexpr(src), mkU8(uImm)));
         assign(argR, binop(mkVecSHRN(insSz),
                           binop(mkVecSHLN(insSz),
                                 mkexpr(src),
                              ...
                              const VexAbiInfo* abiinfo )
{
   ...
   UInt vk     = SLICE(insn, 14, 10);
   UInt insSz  = SLICE(insn, 16, 15);
   UInt insTy  = SLICE(insn, 20, 17);

   IRTemp argR = newTempV128();
   IRTemp res  = newTempV128();
   IROp shiftOp = SLICE(insn, 17, 17) ? mkVecSAR(insSz) : mkVecSHR(insSz);
   const HChar *nm;

   switch (insTy) {
      case 0b1010:
      case 0b1011: {
         nm = (insTy == 0b1010) ? "vsrln" : "vsran";
         assign(argR, binop(shiftOp, getVReg(vj), getVReg(vk)));
         assign(res, binop(mkVecPACKEV(insSz - 1),
                           mkV128(0x0000),
                           mkexpr(argR)));
         break;
      }
      case 0b1100:
      case 0b1101: {
         nm = (insTy == 0b1100) ? "vsrlrn" : "vsrarn";
         argR = vsrlr_ops(vj, vk, shiftOp, insSz);
         assign(res, binop(mkVecPACKEV(insSz - 1),
                           mkV128(0x0000),
                           mkexpr(argR)));
         break;
      ...
      case 0b1110: //vssrln
      case 0b1111: { //vssran
         IRTemp sat = newTempV128();
         UInt shiftNum[3] = { 7, 15, 31 };
         nm = (insTy == 0b1110) ? "vssrln" : "vssran";
         assign(argR, binop(shiftOp, getVReg(vj), getVReg(vk)));
         sat = vsat_s(argR, insSz, shiftNum[insSz-1]);
         assign(res, binop(mkVecPACKEV(insSz - 1),
                           mkV128(0x0000),
                           mkexpr(sat)));
         break;
      }
      case 0b0010: //vssrln{u}
      case 0b0011: { //vssran{u}
         IRTemp sat = newTempV128();
         IRTemp eq = newTempV128();
         UInt shiftNum[3] = { 8, 16, 32 };
         nm = (insTy == 0b0010) ? "vssrln" : "vssran";
         assign(argR, binop(shiftOp, getVReg(vj), getVReg(vk)));
         assign(eq, binop(mkVecCMPEQ(insSz),
                          binop(mkVecSHRN(insSz),
                                mkexpr(argR),
                                mkU8(shiftNum[insSz - 1])),
                          mkV128(0x0000)));
         assign(sat, binop(Iop_OrV128,
                           binop(Iop_AndV128,
                                 mkexpr(eq),
                                 mkexpr(argR)),
                           binop(mkVecSHRN(insSz),
                                 unop(Iop_NotV128, mkexpr(eq)),
                                 mkU8(shiftNum[insSz - 1]))));
         assign(res, binop(mkVecPACKEV(insSz - 1),
                           mkV128(0x0000),
                           mkexpr(sat)));
      ...
      case 0b0001: {
         IRTemp sat = newTempV128();
         nm = (insTy == 0b0000) ? "vssrlrn" : "vssrarn";
         UInt shiftNum[3] = { 7, 15, 31 };
         argR = vsrlr_ops(vj, vk, shiftOp, insSz);
         sat = vsat_s(argR, insSz, shiftNum[insSz-1]);
         assign(res, binop(mkVecPACKEV(insSz - 1),
      ...
      case 0b0100: //vssrlrn{u}
      case 0b0101: { //vssrarn{u}
         IRTemp sat = newTempV128();
         IRTemp eq = newTempV128();
         UInt shiftNum[3] = { 8, 16, 32 };
         nm = (insTy == 0b0010) ? "vssrlrn" : "vssrarn";
         argR = vsrlr_ops(vj, vk, shiftOp, insSz);
         assign(eq, binop(mkVecCMPEQ(insSz),
                          binop(mkVecSHRN(insSz),
                                mkexpr(argR),
...
static IRTemp gen_vsrlri_2 ( IRTemp src, IROp shrOp, UInt insSz, UInt uImm )
{
   IRTemp argL = newTempV128();
   IRTemp argR = newTempV128();
   IRTemp res = newTempV128();
...
static Bool gen_vsrlni_vsrani ( DisResult* dres, UInt insn,
                        const VexArchInfo* archinfo,
                        const VexAbiInfo* abiinfo )
{
   UInt vd     = SLICE(insn, 4, 0);
   UInt vj     = SLICE(insn, 9, 5);
   UInt insImm = SLICE(insn, 17, 10);
   UInt insTy  = SLICE(insn, 20, 18);

   UInt uImm, insSz;
   IRTemp argL = newTempV128();
   IRTemp argR = newTempV128();
   IRTemp svd  = newTempV128();
   IRTemp svj  = newTempV128();
   IRTemp res  = newTempV128();

   assign(svj, getVReg(vj));
   assign(svd, getVReg(vd));
   ...
   switch (insTy) {
      case 0b000: //vsrlni
      case 0b110: { //vsrani
         IROp shiftOp = SLICE(insn, 19, 19) ? mkVecSARN(insSz + 1) :
                                              mkVecSHRN(insSz + 1);
         assign(argR, binop(mkVecPACKEV(insSz),
                            mkV128(0x0000),
                            binop(shiftOp, getVReg(vj), mkU8(uImm))));
         assign(argL, binop(mkVecPACKEV(insSz),
                            mkV128(0x0000),
                            binop(shiftOp, getVReg(vd), mkU8(uImm))));
         assign(res, binop(Iop_InterleaveLO64x2, mkexpr(argL), mkexpr(argR)));
         break;
      }
      case 0b010: //vssrlni
      case 0b011: { //vssrlni{u}
         IROp shiftOp = mkVecSHRN(insSz + 1);
         IRTemp satR = newTempV128();
         IRTemp satL = newTempV128();
         UInt shiftNum[3] = { 7, 15, 31 };
         assign(argR, binop(shiftOp, getVReg(vj), mkU8(uImm)));
         assign(argL, binop(shiftOp, getVReg(vd), mkU8(uImm)));
         assign(satR, binop(mkVecPACKEV(insSz),
                            mkV128(0x0000),
                            mkexpr(vsat_s(argR, insSz + 1, shiftNum[insSz]))));
         assign(satL, binop(mkVecPACKEV(insSz),
                            mkV128(0x0000),
                            mkexpr(vsat_s(argL, insSz + 1, shiftNum[insSz]))));
         assign(res, binop(Iop_InterleaveLO64x2, mkexpr(satL), mkexpr(satR)));
         break;
      }
      case 0b001: //vsrlrni
      case 0b111: { //vsrarni
         IROp shiftOp = SLICE(insn, 19, 19) ? mkVecSARN(insSz + 1) : mkVecSHRN(insSz + 1);
         assign(argR, binop(mkVecPACKEV(insSz),
                            mkV128(0x0000),
                            mkexpr(gen_vsrlri_2(svj, shiftOp, insSz + 1, uImm))));
         assign(argL, binop(mkVecPACKEV(insSz),
                            mkV128(0x0000),
                            mkexpr(gen_vsrlri_2(svd, shiftOp, insSz + 1, uImm))));
         assign(res, binop(Iop_InterleaveLO64x2, mkexpr(argL), mkexpr(argR)));
         break;
      }
      default: vassert(0);
   ...
   const HChar *nm[2] = { "vsrlni", "vsrani" };
   DIP("%s.%s %s, %s, %u\n", nm[SLICE(insn, 18, 18)], mkInsExtSize(insSz),
                             nameVReg(vd), nameVReg(vj), uImm);
   putVReg(vd, mkexpr(res));
   return True;
}
                         ...
                         const VexAbiInfo*  abiinfo )
{
   ...
   // for (i = 0; i < 16; i++){
   //    elem[i] = newTemp(Ity_I8);
   //    assign(elem[i], binop(Iop_GetElem8x16, getVReg(vj), mkU8(i)));

   //    IRExpr_ITE(binop(Iop_CmpEQ64, mkU64(elem[i]), mkU64(0),
   //                ));//id = i;
                               ...
                               const VexAbiInfo* abiinfo )
{
   ...
   if (isI) {
      switch (insSz) {
         case 0b00: assign(argR, unop(Iop_Dup8x16, mkU8(vk))); break;
         case 0b01: assign(argR, unop(Iop_Dup16x8, mkU16(vk))); break;
         case 0b10: assign(argR, unop(Iop_Dup32x4, mkU32(vk))); break;
         case 0b11: assign(argR, binop(Iop_64HLtoV128, mkU64(vk), mkU64(vk))); break;
         default: vassert(0);
      }
   } else {
       assign(argR, getVReg(vk));
                           ...
                           const VexAbiInfo*  abiinfo )
{
   ...
   elem = binop(mkVecGetElem(insSz), getVReg(vj), mkU8(uImm));
   switch (insSz) {
      case 0:
         assign(res, unop(Iop_Dup8x16, elem));
         break;
   ...
   switch (insSz) {
      case 0b00: {
         ...
         for (i = 0; i < 16; i++) {
            ...
            assign(vec[i], binop(Iop_GetElem8x16, getVReg(vj), mkU8(i)));
         }
         ...
         assign(res,
                binop(Iop_64HLtoV128,
                      binop(Iop_32HLto64,
                            binop(Iop_16HLto32,
                                  binop(Iop_8HLto16, mkexpr(vec[id3+12]), mkexpr(vec[id2+12])),
                                  binop(Iop_8HLto16, mkexpr(vec[id1+12]), mkexpr(vec[id0+12]))),
                            binop(Iop_16HLto32,
                                  binop(Iop_8HLto16, mkexpr(vec[id3+8]), mkexpr(vec[id2+8])),
                                  binop(Iop_8HLto16, mkexpr(vec[id1+8]), mkexpr(vec[id0+8])))),
                      binop(Iop_32HLto64,
                            binop(Iop_16HLto32,
                                  binop(Iop_8HLto16, mkexpr(vec[id3+4]), mkexpr(vec[id2+4])),
                                  binop(Iop_8HLto16, mkexpr(vec[id1+4]), mkexpr(vec[id0+4]))),
                            binop(Iop_16HLto32,
                                  binop(Iop_8HLto16, mkexpr(vec[id3]), mkexpr(vec[id2])),
                                  binop(Iop_8HLto16, mkexpr(vec[id1]), mkexpr(vec[id0]))))));
         break;
      }
      case 0b01: {
         IRTemp vec[8];
         ...
         for (i = 0; i < 8; i++) {
            ...
            assign(vec[i], binop(Iop_GetElem16x8, getVReg(vj), mkU8(i)));
         }

         assign(res,
                binop(Iop_64HLtoV128,
                      binop(Iop_32HLto64,
                            binop(Iop_16HLto32, mkexpr(vec[id3+4]), mkexpr(vec[id2+4])),
                            binop(Iop_16HLto32, mkexpr(vec[id1+4]), mkexpr(vec[id0+4]))),
                      binop(Iop_32HLto64,
                            binop(Iop_16HLto32, mkexpr(vec[id3]), mkexpr(vec[id2])),
                            binop(Iop_16HLto32, mkexpr(vec[id1]), mkexpr(vec[id0])))));
         break;
      }
      case 0b10: {
         IRTemp vec[4];
         ...
         for (i = 0; i < 4; i ++) {
            ...
            assign(vec[i], binop(Iop_GetElem32x4, getVReg(vj), mkU8(i)));
         }

         assign(res,
                binop(Iop_64HLtoV128,
                      binop(Iop_32HLto64, mkexpr(vec[id3]), mkexpr(vec[id2])),
                      binop(Iop_32HLto64, mkexpr(vec[id1]), mkexpr(vec[id0]))));
         break;
      }
      case 0b011: {
         IRTemp vec[4];
         ...
         assign(vec[0], unop(Iop_V128to64, getVReg(vd)));
         assign(vec[1], unop(Iop_V128HIto64, getVReg(vd)));
         assign(vec[2], unop(Iop_V128to64, getVReg(vj)));
         assign(vec[3], unop(Iop_V128HIto64, getVReg(vj)));

         assign(res,
                binop(Iop_64HLtoV128, mkexpr(vec[id1]), mkexpr(vec[id0])));
         break;
      }
      default: vassert(0);
   }
...
static Bool gen_vpermi_w ( DisResult* dres, UInt insn,
                           const VexArchInfo* archinfo,
                           const VexAbiInfo*  abiinfo )
{
   UInt vd    = SLICE(insn, 4, 0);
   ...
   for (i = 0; i < 4; i ++) {
      vec[i+4] = newTemp(Ity_I32);
      assign(vec[i+4], binop(Iop_GetElem32x4, getVReg(vd), mkU8(i)));
   }

   DIP("vpermi.w %s, %s, %u\n", nameVReg(vd), nameVReg(vj), ui8);
   putVReg(vd,
           binop(Iop_64HLtoV128,
                 binop(Iop_32HLto64, mkexpr(vec[id3 + 4]), mkexpr(vec[id2 + 4])),
                 binop(Iop_32HLto64, mkexpr(vec[id1]), mkexpr(vec[id0]))));
   return True;
}
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 15)) {
      ...
      case 0b0000001: ok = gen_vstx(dres, insn, archinfo, abiinfo); break;
      case 0b1000000:
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 18)) {
      ...
      case 0b1011: case 0b1101:
         ok = gen_vmaddw_vmsubw(dres, insn, archinfo, abiinfo); break;
      default: ok = False; break;
   }
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 18)) {
      ...
      case 0b1100:
         ...
         break;
      case 0b1101: case 0b1110:
      case 0b1111:
         ok = gen_vsrln_vsran(dres, insn, archinfo, abiinfo); break;
      default: ok = False; break;
   }
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 17)) {
      ...
      case 0b00110: case 0b00111: case 0b01000:
         ok = gen_bitops(dres, insn, archinfo, abiinfo); break;
                                                         ...
                                                         const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 19, 17)) {
      ...
      case 0b111:
         ok = gen_vbsxl_v(dres, insn, archinfo, abiinfo); break;
      default: ok = False; break;
   }
                                                         ...
                                                         const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 17, 14)) {
      case 0b0000:
         ok = gen_vneg(dres, insn, archinfo, abiinfo); break;
      case 0b0001:
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 18)) {
      ...
      case 0b1101:
         ok = gen_vslli(dres, insn, archinfo, abiinfo); break;
      default: ok = False; break;
   }
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 18)) {
      case 0b0000: case 0b0001: case 0b0010: case 0b0011: case 0b0110: case 0b0111:
         ok = gen_vsrlni_vsrani(dres, insn, archinfo, abiinfo); break;
      default: ok = False; break;
   }
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 18)) {
      ...
      case 0b1001:
         ok = gen_vpermi_w(dres, insn, archinfo, abiinfo); break;
      default: ok = False; break;
   }
